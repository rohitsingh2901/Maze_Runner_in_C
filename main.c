...
void caption()
{
  setcolor(12);
  settextstyle(0,HORIZ_DIR,0);
  outtextxy(10,65,"Find your path out of the maze");
  outtextxy(10,80,"or Press 'SPACE' to EXIT");
  setcolor(WHITE);
}
int level_1(int *p)
{
 ...
 outtextxy(40,100,"PATH FINDER");
 settextstyle(0,HORIZ_DIR,0);
 setcolor(9);
 outtextxy(120,380,"Press 'space' to play the level");
